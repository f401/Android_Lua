 ...
 */
public abstract class AbstractAsyncFormatter implements IFormatter {
    ...
    /**
     * like {@link IFormatter#format(Content, TextRange)}, but run in background thread.
     * <p>
    ...
    /**
     * like {@link IFormatter#formatRegion(Content, TextRange, TextRange)}, but run in background thread
     * <p>
     * Implementation of this method can edit text directly to generate formatted code.
     *
     * @return the new cursor range to be applied to the text
