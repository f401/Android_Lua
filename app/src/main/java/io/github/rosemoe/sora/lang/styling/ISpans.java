...
public interface ISpans {
    ...
    /**
     * Reader reads the spans in a {@link ISpans} object.
     */
    interface Reader {

        /**
         * Start reading the spans on the given line.
         * You may prepare some data here if the actual spans are not stored by {@link ISpan} objects.
         * <p>
         ...
         */
        List<ISpan> getSpansOnLine(int line);

    }

    /**
     * Modifier updates the spans in a {@link ISpans} object.
     */
    interface Modifier {
         ...
         */
        void setSpansOnLine(int line, List<ISpan> spans);
         ...
         * but the content of it can be copied.
         */
        void addLineAt(int line, List<ISpan> spans);
